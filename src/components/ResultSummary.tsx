...
export default function ResultSummary() {
  return (
    <div className={mainFont.className}>
      <div className="m-4 flex flex-col rounded-3xl bg-white text-white shadow-lg sm:flex-row">
        <div className="min-w-xs flex flex-col items-center justify-center gap-8 rounded-3xl bg-gradient-to-t from-blue-500 to-sky-600 p-8 sm:max-w-xs sm:gap-10">
          <h1 className="text-2xl font-semibold text-sky-50">Your Result</h1>
          <p className="flex h-56 w-56 flex-col items-center justify-center gap-2 rounded-full bg-gradient-to-t from-transparent to-blue-950/40 text-xl text-gray-400 sm:h-48 sm:w-48 sm:text-base">
            <span className="text-8xl font-bold text-white sm:text-7xl">
              76
            </span>
            of 100
          </p>
          <p className="flex flex-col items-center gap-2 text-center text-sm">
            <span className="text-xl font-semibold">Great</span>
            <span>
              You scored higher than <span>65%</span> of the people who have
              taken these tests.
            </span>
          </p>
        </div>
        <div className="flex flex-col gap-6  p-8 text-gray-950 sm:gap-8">
          <h2 className="text-xl font-semibold">Summary</h2>
          <div className="flex min-w-[16rem] flex-col gap-2">
            <div className="flex justify-between rounded-md bg-gradient-to-r from-red-500/10 to-red-200/5 p-2 sm:p-4">
            ...
            <div className="flex justify-between rounded-md bg-yellow-500/10 p-2 sm:p-4">
            ...
            <div className="flex justify-between rounded-md bg-green-500/10 p-2 sm:p-4">
            ...
            <div className="flex justify-between rounded-md bg-violet-500/10 p-2 sm:p-4">
          ...
          <button className="rounded-full bg-sky-700 p-2 text-white transition duration-75 hover:bg-sky-800 hover:shadow-md active:translate-y-0.5">
            Continue
          </button>
        </div>
      </div>
