...
export default function ResultSummary() {
	return (
		<div className={mainFont.className}>
			<div className="flex flex-col m-4 text-white bg-white shadow-lg sm:flex-row rounded-3xl">
				<div className="flex flex-col items-center justify-center gap-8 p-8 sm:gap-10 sm:max-w-xs min-w-xs bg-gradient-to-t from-blue-500 to-sky-600 rounded-3xl">
					<h1 className="text-2xl font-semibold text-sky-50">Your Result</h1>
					<p className="flex flex-col items-center justify-center w-56 h-56 gap-2 text-xl text-gray-400 rounded-full sm:w-48 sm:h-48 bg-gradient-to-t from-transparent to-blue-950/40 sm:text-base">
						<span className="font-bold text-white text-8xl sm:text-7xl">76</span> of 100
					</p>
					<p className="flex flex-col items-center gap-2 text-sm text-center">
						<span className="text-xl font-semibold">Great</span>
						<span>
							You scored higher than <span>65%</span> of the people who have taken
							these tests.
						</span>
					</p>
				</div>
				<div className="flex flex-col gap-6 p-8 sm:gap-8 text-gray-950">
					<h2 className="text-xl font-semibold">Summary</h2>
					<div className="flex flex-col gap-2 min-w-[16rem]">
						<div className="flex justify-between p-2 rounded-md sm:p-4 bg-gradient-to-r from-red-500/10 to-red-200/5">
						...
						<div className="flex justify-between p-2 rounded-md sm:p-4 bg-yellow-500/10">
						...
						<div className="flex justify-between p-2 rounded-md sm:p-4 bg-green-500/10">
						...
						<div className="flex justify-between p-2 rounded-md sm:p-4 bg-violet-500/10">
					...
					<button className="p-2 text-white transition duration-75 rounded-full bg-sky-700 hover:bg-sky-800 hover:shadow-md active:translate-y-0.5">
						Continue
					</button>
				</div>
			</div>
